...
public class PruebaDetectorVehiculos {
	public static void main (String[] args) {
		...
		System.out.println("Buscando vehiculo que no esta: " + dv1.buscaVehiculo(new Vehiculo ("id" + 99, new Vector(99, 99), 99, new Vector(99, 99), 99 + 1)));
		System.out.println("Buscando vehiculo que no esta: " + dv1.buscaVehiculo(new Vehiculo ("id" + 100, new Vector(100, 100), 100, new Vector(100, 100), 100 + 1)));
		...
		//getVehiculos con un selector=null
		System.out.println("GetVehiculos con un selector=null: ");
		SelectorVehiculo sNull = null;
		List<Vehiculo> vs2 = dv2.getVehiculos(sNull);
		for (Vehiculo v : vs2)
			System.out.println(v);
		//
